...
Please bear in mind that this chapter only gives a very short, incomplete and simplified view on the Scala language. There are many resources available online for learning Scala, a good starting point would be http://www.scala-lang.org[www.scala-lang.org]. The discussion here should serve as a starting point, provide you with the bare minimum to start and to be able to write useful programs.
